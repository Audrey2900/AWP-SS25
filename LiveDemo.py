...
import data.livedemopages as livedemopages
...
with st.sidebar:
    ...
    st.button("Onboarding", on_click=set_page, args=("onboarding",))
    st.markdown("<div style='height: 10px;'></div>", unsafe_allow_html=True)
    st.button("Corona-FakeNews", on_click=set_page, args=("corona",))
    st.markdown("<div style='height: 10px;'></div>", unsafe_allow_html=True)
    st.button("Fact Checkers", on_click=set_page, args=("factcheckers",))
    st.markdown("<div style='height: 10px;'></div>", unsafe_allow_html=True)
    st.button("Ai-FakeNews", on_click=set_page, args=("aifakenews",))
    st.markdown("<div style='height: 10px;'></div>", unsafe_allow_html=True)
    st.button("Offboarding", on_click=set_page, args=("offboarding",))

livedemopages.render()
